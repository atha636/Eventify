...
const modalStyles = `
  ...
  .dm-confirm:hover:not(:disabled):not(.loading) {
    background: #a04848; transform: translateY(-1px); box-shadow: 0 6px 18px rgba(184,92,92,0.3);
  }
...
const cardStyles = `
  ...
  .sc-gallery-hint {
    ...
    gap: 8px; background: rgba(14,12,10,0);
    color: white; font-size: 12.5px; letter-spacing: 0.05em;
  ...
  .sc-title {
    ...
    font-size: 1.15rem; font-weight: 600; color: var(--ink); margin-bottom: 5px;
  ...
  .sc-btn {
    ...
    font-size: 12.5px; font-weight: 500; cursor: pointer; transition: all 0.22s ease;
