...
export default function AddService() {
  ...
  // ── Go back safely (works regardless of route name) ───────────
          ...
          {success ? (
            ...
            <div className="as-success-screen">
              ...
              <div className="as-success-btns">
                {/* ✅ FIX: use navigate(-1) so it always goes to wherever the vendor came from */}
                <button className="as-btn-primary" onClick={goBack}>Go to Dashboard →</button>
                <button
            ...
            <div className={`as-layout ${isComingSoon ? "as-layout-full" : ""}`}>
              ...
              <div className={isComingSoon ? "as-coming-soon-layout" : "as-form-col"}>
                ...
                <div className="as-form-header">
                  {/* ✅ FIX: button instead of <a href>, uses navigate(-1) */}
                ...
                {!isComingSoon && (
                  <>
                    ...
                    <div className="as-actions">
                      {/* ✅ FIX: button with navigate(-1), no broken href */}
                      <button className="as-btn-ghost-full" onClick={goBack} disabled={saving}>
                        Cancel
                      </button>
                      <button
                  ...
                  <div className="as-preview-sticky">
                    ...
                    <div className="as-preview-card">
                      ...
                      <div className="as-preview-body">
                        ...
                        <p className="as-preview-loc">{form.location ? `◉ ${form.location}` : "◉ Location"}</p>
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ✅ FIX: back is now a button styled like a link */
  .as-back {
  ...
  .as-title { font-family: 'Cormorant Garamond', serif; font-size: clamp(1.9rem, 3.5vw, 2.6rem); font-weight: 300; color: var(--ink); margin-bottom: 8px; line-height: 1.15; }
  ...
  .as-cs-heading { font-family: 'Cormorant Garamond', serif; font-size: clamp(2rem, 4vw, 2.8rem); font-weight: 300; color: var(--ink); line-height: 1.1; margin-bottom: 14px; animation: fadeUp 0.5s ease both; animation-delay: 0.2s; }
  ...
  .as-cs-back-btn { background: none; border: 1px solid var(--border); border-radius: 7px; padding: 11px 22px; font-family: 'DM Sans', sans-serif; font-size: 13px; color: var(--muted); cursor: pointer; transition: all 0.2s; letter-spacing: 0.02em; animation: fadeUp 0.5s ease both; animation-delay: 0.4s; }
  ...
  .as-pkg-remove { background: none; border: none; cursor: pointer; color: #ccc; font-size: 20px; line-height: 1; padding: 2px 6px; border-radius: 4px; transition: color 0.2s; font-family: 'DM Sans', sans-serif; }
  ...
  .as-pkg-remove-feat { background: none; border: none; cursor: pointer; color: #ccc; font-size: 16px; line-height: 1; padding: 0 4px; transition: color 0.2s; flex-shrink: 0; font-family: 'DM Sans', sans-serif; }
  ...
  .as-add-pkg-btn { width: 100%; padding: 14px; background: none; border: 1px dashed rgba(201,168,76,0.4); border-radius: 10px; color: var(--muted); font-family: 'DM Sans', sans-serif; font-size: 13px; cursor: pointer; transition: all 0.2s; letter-spacing: 0.03em; margin-top: 2px; }
  .as-add-pkg-btn:hover { border-color: var(--gold); color: var(--ink); background: rgba(201,168,76,0.04); }

  /* ── IMAGE PREVIEW GRID ── */
  .as-img-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(96px, 1fr)); gap: 10px; margin-bottom: 10px; animation: fadeUp 0.3s ease both; }
  ...
  .as-upload-label { display: inline-block; padding: 9px 22px; background: var(--ink); color: var(--white); border-radius: 6px; font-family: 'DM Sans', sans-serif; font-size: 12.5px; font-weight: 500; cursor: pointer; transition: all 0.2s; letter-spacing: 0.03em; }
  ...
  .as-btn-ghost-full { padding: 16px; background: none; border: 1px solid var(--border); border-radius: 7px; font-family: 'DM Sans', sans-serif; font-size: 14px; color: var(--muted); cursor: pointer; transition: all 0.2s; }
  ...
  .as-preview-title { font-family: 'Cormorant Garamond', serif; font-size: 1.2rem; font-weight: 600; color: var(--ink); margin-bottom: 5px; min-height: 1.5em; }
  ...
  /* ── SUCCESS ── */
  .as-success-screen { max-width: 480px; margin: 80px auto; text-align: center; animation: fadeUp 0.5s ease both; }
  .as-success-icon { width: 70px; height: 70px; background: rgba(45,106,79,0.1); border: 1px solid rgba(45,106,79,0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 28px; color: #2d6a4f; margin: 0 auto 24px; animation: popIn 0.4s cubic-bezier(0.175,0.885,0.32,1.275) both; }
  .as-success-screen h2 { font-family: 'Cormorant Garamond', serif; font-size: 2rem; font-weight: 600; color: var(--ink); margin-bottom: 10px; }
  ...
  .as-btn-primary { padding: 13px 28px; background: var(--ink); color: var(--white); text-decoration: none; border: none; border-radius: 7px; font-size: 13px; font-weight: 500; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.2s; }
  .as-btn-primary:hover { background: var(--gold); color: var(--ink); }
  .as-btn-ghost { padding: 13px 28px; background: none; color: var(--muted); border: 1px solid var(--border); border-radius: 7px; font-family: 'DM Sans', sans-serif; font-size: 13px; cursor: pointer; transition: all 0.2s; }
  ...
  @media (max-width: 640px) {
    .as-body { padding: 32px 16px 60px; }
