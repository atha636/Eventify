  ...
  return (
    <div className="bd-overlay" onClick={handleBackdrop}>
      <div className="bd-modal">
        ...
        {/* ── DATE CHANGE REQUEST (if pending) ── */}
        {hasDcr && (
                ...
                {filtered.map((b, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* RIGHT — stop propagation so buttons don't open detail popup */}
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .bd-overlay {
    ...
    background: rgba(14,12,10,0.6); backdrop-filter: blur(8px);
  ...
  .bd-modal {
    ...
    padding: 40px 36px 32px; width: min(580px, 95vw);
    max-height: 90vh; overflow-y: auto;
    box-shadow: 0 40px 100px rgba(0,0,0,0.22);
    animation: popupUp 0.3s cubic-bezier(0.34,1.15,0.64,1) both;
  ...
  .bd-avatar {
    ...
    display: flex; align-items: center; justify-content: center;
    font-family: 'Cormorant Garamond', serif; font-size: 1.5rem; font-weight: 600; flex-shrink: 0;
  }
  ...
  .bd-dcr-tag {
    ...
    color: #8a6f1e; background: rgba(201,168,76,0.12); border: 1px solid rgba(201,168,76,0.25);
  ...
  .bd-accept-btn {
    ...
    font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; cursor: pointer; transition: all 0.22s;
  ...
  .bd-reject-btn {
    flex: 1; padding: 14px 16px; background: rgba(184,92,92,0.08); color: #b85c5c;
