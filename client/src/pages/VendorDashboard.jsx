...
function DashboardHelmet({ vendorName, serviceCount, pendingCount }) {
  useEffect(() => {
    ...
    // Robots – vendor dashboard should not be indexed
...
function AvailabilityCalendar({ services, onClose }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // handled silently; error feedback via toast in parent
    } finally {
      setSaving(false);
    }
  };
        ...
        {loading ? (
          ...
          <>
            ...
            <div
              className="ac-grid"
              role="grid"
              aria-label={`${monthName} ${viewYear} availability calendar`}
            >
              ...
              {[...Array(daysInMonth)].map((_, i) => {
                ...
                const label = isPast
                  ...
                  : isUnavailable
                    ? `${day} ${monthName}, marked unavailable – click to mark available`
                    : `${day} ${monthName}, available – click to mark unavailable`;
      ...
      <div className="bd-modal">
        ...
        <div className="bd-top">
          ...
          <span
            ...
            aria-label={`Booking status: ${meta.label}`}
          >
            {meta.label}
          </span>
        </div>
        ...
        {/* ── Payment banner ── */}
        <div
          className="bd-pay-banner"
          style={{ background: payMeta.bg, border: `1px solid ${payMeta.border}` }}
          role="status"
          aria-label={payMeta.label}
        >
          <div className="bd-pay-icon-wrap" style={{ color: payMeta.color }} aria-hidden="true">
        ...
        <dl className="bd-grid">
          <div className="bd-info-block">
            <dt className="bd-info-label">Booking Date</dt>
            <dd className="bd-info-value">🗓 {fmt(b.date)}</dd>
          </div>
          <div className="bd-info-block">
            <dt className="bd-info-label">Package</dt>
            <dd className="bd-info-value">📦 {b.packageName || "—"}</dd>
          </div>
          <div className="bd-info-block">
            <dt className="bd-info-label">Package Price</dt>
            <dd className="bd-info-value">₹ {b.packagePrice?.toLocaleString() || "—"}</dd>
          </div>
          <div className="bd-info-block">
            <dt className="bd-info-label">Booked On</dt>
            <dd className="bd-info-value">{b.createdAt ? fmtTime(b.createdAt) : "—"}</dd>
          </div>
        </dl>
        ...
        <address className="bd-client-details">
          {b.userDetails?.name && (
            <div className="bd-detail-row">
              <span className="bd-detail-icon" aria-hidden="true">👤</span>
              <div>
          ...
          {b.userDetails?.phone && (
            <div className="bd-detail-row">
              ...
              <div>
                ...
                <a className="bd-detail-value bd-detail-link" href={`tel:${b.userDetails.phone}`}>
                  {b.userDetails.phone}
                </a>
              </div>
            </div>
...
function DateChangePopup({ booking, onAccept, onReject, responding }) {
  ...
  return (
    <div
      className="vd-popup-overlay"
      role="alertdialog"
      aria-modal="true"
      aria-labelledby="dcp-title"
      aria-describedby="dcp-desc"
    >
      <div className="vd-popup">
        ...
        <p id="dcp-desc" className="vd-popup-sub">
    ...
    sections: [
      {
        ...
        body: "We collect information you provide directly — such as your name, email, business details, and service listings — as well as booking data generated through your vendor account.",
      },
      {
        heading: "How We Use Your Information",
        body: "Your data is used to operate the platform, process bookings, send important notifications, and improve our services. We do not sell your personal information to third parties.",
      },
      {
        heading: "Data Security",
        body: "All data is transmitted over HTTPS and stored with industry-standard encryption. Access to vendor data is restricted to authorised personnel only.",
      },
      {
        heading: "Cookies",
        body: "We use essential cookies to keep you logged in and remember your preferences. No advertising or third-party tracking cookies are used on the vendor portal.",
      },
      {
        heading: "Your Rights",
    ...
    sections: [
      {
        ...
        body: "By accessing or using the Vendor Portal, you agree to be bound by these Terms of Service. If you do not agree, please discontinue use immediately.",
      },
      {
        heading: "Vendor Responsibilities",
        body: "You are responsible for maintaining accurate service listings, responding to booking requests in a timely manner, and honouring approved bookings. Misrepresentation may result in account suspension.",
      },
      {
        heading: "Payments",
        body: "All payments are processed through our secure payment gateway. The platform charges a service fee on completed bookings as outlined in your vendor agreement.",
      },
      {
        heading: "Cancellations",
        body: "Cancellation policies are governed by your individual service settings. Repeated cancellations may affect your vendor standing and search visibility.",
      },
      {
        heading: "Intellectual Property",
        body: "All content you upload (photos, descriptions) remains your property. You grant us a limited licence to display it on the platform for the purpose of attracting bookings.",
      },
      {
        heading: "Limitation of Liability",
        body: "The platform is provided 'as is'. We are not liable for indirect or consequential damages arising from use of the service.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Review incoming bookings under the Bookings section. Click any card to open full details. Use the Accept / Reject buttons to respond, or click 'View details →' for more options.",
      },
      {
        heading: "Availability Calendar",
        body: "Click 'Manage Calendar' in the dashboard header to block out dates you're unavailable. Blocked dates won't appear in client searches.",
      },
      {
        heading: "Adding Services",
        body: "Click '+ Add New Service' to create a new listing. Fill in your title, description, packages, and photos. Your service goes live immediately after saving.",
      },
      {
        heading: "Date Change Requests",
        body: "When a client requests a date or address change, a banner will appear at the top of your bookings. Review and accept or decline the changes — the client is notified instantly.",
      },
      {
...
export default function VendorDashboard() {
  ...
  // Fetch vendor profile for SEO title
  useEffect(() => {
    const token = localStorage.getItem("token");
  ...
  const handleConfirmUndo  = async () => {
    ...
    try {
      ...
      setDetailBooking((prev) =>
        prev && prev._id === undoTarget._id ? { ...prev, status: "pending" } : prev
      );
    } finally {
      setConfirming(false);
    }
    ...
    <>
      ...
      <div className="vd-root">
        ...
        <main id="vd-main-content" className="vd-body">
          ...
          <header className="vd-header" role="banner">
            <div className="vd-header-left">
              ...
              <h1 className="vd-title">
                {vendorName ? `${vendorName}'s Dashboard` : "Dashboard"}
              </h1>
          ...
          <section className="vd-section" aria-labelledby="services-heading">
            <div className="vd-section-header">
              ...
              <a href="/add-service" className="vd-section-add" aria-label="Add a new service">
                + New Service
              </a>
            </div>
          ...
          <section className="vd-section" aria-labelledby="bookings-heading">
            ...
            <div className="vd-tabs" role="tablist" aria-label="Filter bookings by status">
              {TABS.map(({ key, label }) => (
                ...
                >
                  {label}
                  <span className="vd-tab-count" aria-label={`${counts[key]} bookings`}>
                    {counts[key]}
                  </span>
                </button>
              ))}
            ...
            {loadingB ? (
              ...
              <div className="vd-empty" role="status" id="bookings-list">
                ...
                {searchQuery && (
                  <button className="vd-clear-search-btn" onClick={() => setSearchQuery("")}>
                    Clear search
                  </button>
                )}
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        aria-label={`View details for ${b.userId?.name || "Unknown Client"}'s booking on ${new Date(b.date).toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric" })}`}
                      >
                      ...
                      {/* Right-side actions (outside the main button) */}
                      <div className="vd-booking-right" onClick={(e) => e.stopPropagation()}>
                        <span
                          className="vd-pay-chip"
                          style={{ color: payMeta.color, background: payMeta.bg, border: `1px solid ${payMeta.border}` }}
                          aria-label={payMeta.label}
                        >
                          ...
                          <div className="vd-actions" role="group" aria-label="Quick actions">
                            ...
                            >
                              {updating === b._id + "approved"
                                ? <span className="vd-spinner" aria-hidden="true" />
                                : "✓ Accept"}
                            </button>
                            <button
                            ...
                            >
                              {updating === b._id + "rejected"
                                ? <span className="vd-spinner vd-spinner-dark" aria-hidden="true" />
                                : "✕ Reject"}
                            </button>
                          </div>
                        )}
                        ...
                        {b.status === "approved" && !hasDcr && (
                          <button
                            ...
                            onClick={() => handleRequestUndo(b)}
                            aria-label="Move booking back to pending"
                          >
                            Undo
                          </button>
                        )}
        ...
        <footer className="vd-footer-bar" role="contentinfo">
          <p className="vd-footer-text">
            © {new Date().getFullYear()} Vendor Portal. All bookings are secured and private.
          </p>
...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .toast-wrap {
    ...
    z-index: 9999; width: min(420px, 92vw);
  ...
  .toast-close {
    ...
    font-size: 11px; color: var(--muted); width: 24px; height: 24px;
  ...
  .ac-modal {
    ...
    padding: 36px 32px 28px; width: min(600px, 98vw); max-height: 96vh;
  ...
  .ac-close:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .ac-service-select {
    ...
    font-size: 13px; color: var(--ink); outline: none; cursor: pointer; transition: border-color 0.2s;
  }
  ...
  .ac-instruction {
    font-size: 12.5px; color: var(--muted); line-height: 1.6; margin-bottom: 18px;
  ...
  .ac-nav-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .ac-day-header {
    ...
    letter-spacing: 0.1em; text-transform: uppercase; color: var(--muted); padding: 6px 0;
  }
  .ac-day-cell {
    ...
    font-family: 'DM Sans', sans-serif; background: none; min-height: 36px;
  }
  .ac-day-cell:focus-visible { outline: 2px solid var(--gold); outline-offset: 1px; }
  ...
  .ac-month-stat {
    font-size: 11.5px; color: var(--muted); text-align: center; margin-bottom: 8px;
    padding: 6px 12px; background: rgba(184,92,92,0.06);
    border: 1px solid rgba(184,92,92,0.18); border-radius: 20px;
  ...
  .ac-cancel-btn {
    flex: 1; padding: 12px 16px; background: none; color: var(--muted);
  ...
  .ac-save-btn {
    flex: 2; padding: 12px 16px; background: var(--ink); color: var(--white);
  ...
  .ac-save-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  ═══════════════════════════════════════════ */
  .cu-overlay {
    position: fixed; inset: 0; background: rgba(14,12,10,0.65); backdrop-filter: blur(8px);
    display: flex; align-items: center; justify-content: center;
    z-index: 1300; padding: 20px; animation: fadeIn 0.18s ease both;
  }
  .cu-modal {
    background: var(--white); border: 1px solid rgba(201,168,76,0.25); border-radius: 20px;
    padding: 36px 32px 30px; width: min(440px, 95vw);
    box-shadow: var(--shadow-lg); animation: popupUp 0.28s cubic-bezier(0.34,1.2,0.64,1) both; text-align: center;
  }
  .cu-icon-wrap {
  ...
  .cu-cancel-btn {
    flex: 1; padding: 13px 16px; background: none; color: var(--muted);
    border: 1px solid var(--border); border-radius: 10px;
    font-family: 'DM Sans', sans-serif; font-size: 13px; cursor: pointer; transition: all 0.2s;
  }
  ...
  .cu-confirm-btn {
    flex: 2; padding: 13px 16px; background: var(--ink); color: var(--white);
    border: none; border-radius: 10px;
    font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500;
    cursor: pointer; transition: all 0.22s;
    display: flex; align-items: center; justify-content: center; gap: 6px;
  ...
  .cu-confirm-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  @media (max-width: 600px) { .cu-btns { flex-direction: column; } .cu-modal { padding: 28px 20px 24px; } }
  ...
  .bd-close:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .bd-accept-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .bd-reject-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .bd-undo-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-popup-reject-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-popup-accept-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  @media (max-width: 600px) { .vd-popup { padding: 28px 20px 24px; } .vd-popup-btns { flex-direction: column; } }
  ...
  .vd-add-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 3px; }
  ...
  .vd-avail-btn {
    ...
    border: 1px solid var(--border); border-radius: 8px;
    font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500;
    color: var(--ink); cursor: pointer; transition: all 0.22s; white-space: nowrap;
  }
  ...
  .vd-avail-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-dcr-alert:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-section-add:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-svc-empty {
    background: var(--white); border: 1px dashed rgba(201,168,76,0.35);
  ...
  .vd-tab {
    ...
    transition: all 0.2s; margin-bottom: -1px; text-transform: capitalize;
  }
  .vd-tab:hover { color: var(--ink); }
  .vd-tab.active { color: var(--ink); border-bottom-color: var(--gold); font-weight: 500; }
  .vd-tab:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-booking-card {
    ...
    animation: fadeUp 0.45s ease both; transition: box-shadow 0.25s, border-color 0.25s, transform 0.2s;
    overflow: hidden;
  }
  ...
  .vd-booking-card-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: -2px; border-radius: 12px; }
  ...
  .vd-accept-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-reject-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-undo-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }

  .vd-dcr-pill {
    display: flex; align-items: center; gap: 8px; flex-wrap: wrap; margin-top: 8px;
    padding: 8px 12px; background: rgba(201,168,76,0.08); border: 1px solid rgba(201,168,76,0.25);
  ...
  .vd-dcr-pill:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .vd-clear-search-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  ...
  .lm-overlay {
    position: fixed; inset: 0;
    background: rgba(14,12,10,0.65); backdrop-filter: blur(10px);
    display: flex; align-items: center; justify-content: center;
  ...
  .lm-close:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  .lm-header {
  ...
  .lm-section-body {
    font-size: 13.5px; color: #4a4540; line-height: 1.75;
  }
  .lm-footer {
  ...
  .lm-close-btn:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; }
  @media (max-width: 600px) {
    .lm-header { padding: 22px 20px 16px; }
    .lm-body { padding: 18px 20px; }
    .lm-footer { padding: 14px 20px 20px; }
  }
  ...
  .vd-footer-bar {
    ...
    background: rgba(245,240,232,0.8); backdrop-filter: blur(8px);
  }
  .vd-footer-text { font-size: 11.5px; color: var(--muted); }
  .vd-footer-links { display: flex; gap: 20px; }
  .vd-footer-link { font-size: 11.5px; color: var(--muted); text-decoration: none; transition: color 0.2s; }
  .vd-footer-link:hover { color: var(--gold); }
  .vd-footer-link:focus-visible { outline: 2px solid var(--gold); outline-offset: 2px; border-radius: 2px; }
